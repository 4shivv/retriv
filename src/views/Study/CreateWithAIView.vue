<template>
  <div class="study-page">
    <div class="study-header">
      ...
      <p class="study-description">Let AI create study cards based on your content or questions</p>
    </div>
    ...
    <div class="study-content">
          ...
          <div class="source-type-options">
            ...
            >
              ...
              <div class="option-content">
                <h3>Paste Text</h3>
                <p>Paste your text content and AI will generate study cards</p>
              </div>
            </div>
            ...
            >
              ...
              <div class="option-content">
                <h3>Ask Question</h3>
                <p>Ask a question and AI will create study cards with answers</p>
              </div>
            </div>
            ...
            >
              ...
              <div class="option-content">
                <h3>Upload File</h3>
                <p>Upload a document and AI will extract study cards</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div v-if="aiStep === 'preview'" class="ai-preview-container">
        <div class="preview-header">
          <h2 class="preview-title">AI-Generated Study Materials</h2>
